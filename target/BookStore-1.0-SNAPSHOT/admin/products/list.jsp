							...
							<c:forEach items="${pageResult.list}" var="product">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
											href="${pageContext.request.contextPath}/getProduct?productId=${product.id}">
										<img
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
											href="${pageContext.request.contextPath}/deleteProduct?productId=${product.id}" onclick="return confirm('您确定要删除这本书籍吗？')">
										<img
