...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/editProduct?id=${product.id}" method="post"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><select name="category"
					id="category">
						...
						<option value="生活" ${product.category == '生活' ? 'selected' : ''}>生活</option>
						<option value="计算机" ${product.category == '计算机' ? 'selected' : ''}>计算机</option>
						<option value="外语" ${product.category == '外语' ? 'selected' : ''}>外语</option>
						<option value="经营" ${product.category == '经营' ? 'selected' : ''}>经营</option>
						<option value="励志" ${product.category == '励志' ? 'selected' : ''}>励志</option>
						<option value="社科" ${product.category == '社科' ? 'selected' : ''}>社科</option>
						<option value="学术" ${product.category == '学术' ? 'selected' : ''}>学术</option>
						<option value="少儿" ${product.category == '少儿' ? 'selected' : ''}>少儿</option>
						<option value="艺术" ${product.category == '艺术' ? 'selected' : ''}>艺术</option>
						<option value="原版" ${product.category == '原版' ? 'selected' : ''}>原版</option>
						<option value="科技" ${product.category == '科技' ? 'selected' : ''}>科技</option>
						<option value="考试" ${product.category == '考试' ? 'selected' : ''}>考试</option>
						<option value="生活百科" ${product.category == '生活百科' ? 'selected' : ''}>生活百科</option>
				</select></td>
			</tr>
