			...
			<tr>
				<td width="25%"><table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath}/modifyUserInfo">用户信息修改</a>
							</td>
						</tr>

						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a href="${pageContext.request.contextPath}/order?action=findOrderById">订单查询</a>
							</td>
						</tr>
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td style="padding:20px"><p>欢迎您光临商城！</p>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<c:forEach items="${orders}" var="order" varStatus="vs">
										...
										<tr>
											...
											<td class="tableopentd03"><a href="${pageContext.request.contextPath}/order?action=findOrderByOrderId&orderid=${order.id}">查看</a>&nbsp;&nbsp;
												<a href="#">刪除</a>
											</td>
										</tr>
