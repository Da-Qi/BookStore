...
<script type="text/javascript">
	function buyConfirm(){
		confirm('您所购商品已成功加入购物车，感谢您的选择！');
		/*location.href='${pageContext.request.contextPath}/addCart?id=${book.id}';*/
	}
</script>
<body class="main">
									...
									<tr>
										<td width="30%">
											...
											<div style="text-align:center; margin-top:25px">
												<a href="${pageContext.request.contextPath}/cart?action=addCart&id=${book.id}" onclick="buyConfirm()">
